...
<template>
    <div class="auth-wrap">
        <div class="auth-card">
            ...
            <p class="subtitle">Sign in to continue your streak.</p>
            ...
            <form @submit.prevent="submit" novalidate>
                ...
                >
                    ...
                    <transition name="fade">
                        <p v-if="form.errors.email" id="email-error" class="error">
                            {{ form.errors.email }}
                        </p>
                    </transition>
                </div>
                ...
                >
                    ...
                    />
                    <transition name="fade">
                        <p v-if="form.errors.password" id="password-error" class="error">
            ...
            <p class="alt">No account? <a href="/register" class="link">Create one</a></p>
        </div>
    </div>
</template>
...
.row {
    ...
    .remember {
        ...
        color: var(--text-muted);
        font-size: .95rem;
        input { accent-color: var(--accent-baby-blue); }
    }
}
.btn {
    width: 100%;
